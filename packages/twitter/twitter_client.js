...
Twitter.requestCredential = function (options, credentialRequestCompleteCallback) {
  ...
  var config = ServiceConfiguration.configurations.findOne({service: 'twitterx'});
  ...
  var loginStyle = OAuth._loginStyle('twitterx', config, options);

  // url to app, enters "step 1" as described in
  // packages/accounts-oauth1-helper/oauth1_server.js
  var loginPath = '_oauth/twitterx/?requestTokenAndRedirect=true'
